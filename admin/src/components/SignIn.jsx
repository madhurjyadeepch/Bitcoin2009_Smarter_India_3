...
const SignIn = ({ setIsSignedIn }) => {
    ...
    const departments = [
        { id: 'mohua', name: 'Ministry of Housing & Urban Affairs' },
    ...
    const handleSignIn = async (e) => {
        e.preventDefault();
        if (!email || !password || !department) { setError('All fields are required.'); return; }
        ...
        <div className="signin-page">
                ...
                <div className="signin-features">
                    ...
                    <div className="signin-feature">
                        ...
                        <div>
                            ...
                            <p>Update status, prioritize, and resolve reports efficiently</p>
                        </div>
                    </div>
                    <div className="signin-feature">
                        ...
                        <div>
                            ...
                            <p>See upvotes and citizen feedback on every issue</p>
                        </div>
                    </div>
                </div>
            </div>
            <div className="signin-right">
                <form className="signin-form" onSubmit={handleSignIn}>
                    <h2>Sign In</h2>
                    <p className="signin-form-subtitle">Access the authority management dashboard</p>
