    ...
    <nav className="admin-navbar">
      <div className="admin-navbar-content">
        <div className="admin-navbar-brand">
          ...
          <Link to="/" className="admin-navbar-title" style={{ textDecoration: 'none' }}>Lok Samadhan</Link>
          <span className="admin-navbar-badge">Admin</span>
        </div>
        
        <div className="admin-navbar-links">
          <Link to="/" className={`nav-link ${location.pathname === '/' ? 'active' : ''}`}>Dashboard</Link>
          <Link to="/workers" className={`nav-link ${location.pathname === '/workers' ? 'active' : ''}`}>Workers</Link>
        </div>
